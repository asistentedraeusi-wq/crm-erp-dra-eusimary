...
const MEDICAMENTOS_LISTA = [
  ...
  { label: 'Semaglutida 0.10 mg/dosis — Wegovy® (inyectable semanal)',       nombre: 'Semaglutida 0.10 mg/dosis (Wegovy®) — Solución inyectable subcutánea, pluma precargada. Aplicación semanal el mismo día de la semana.' },
